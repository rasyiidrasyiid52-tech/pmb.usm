    ...
    <div class="login-logo">
      ...
      <div class="card shadow">
        <div class="card-body login-card-body" style="border-radius: 10px;">
         ...
         <form action="newpassword"  method="post" autocomplete="" class="form-horizontal" role="form">
          <?php 
          ...
          <div class="row">
            <div class="col-sm-6 col-md-6">
              <center>
                <button style="border-radius: 20px;border: 2px solid #EFE4E4;width: 100%;" class="btn btn-sm bg-primary" name="change-password"><i class="fa fa-check faa-tada animated-hover"></i> Simpan</button> 
             </center>
           </div> 
           <div class="col-sm-6 col-md-6">
            <center>
