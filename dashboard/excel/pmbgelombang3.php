...
header("Content-Disposition: attachment; filename=PMB Gelombang 3 $tgl.xls");
...
<body>
  ...
  <table>
    ...
    <tr style="text-transform: uppercase;"><th colspan="53" align="left" style="text-transform: uppercase;"><h1 style="text-transform: uppercase;">Data PMB Gelombang 2 <?php echo $app['nama']?></h1></th></tr>
    <tr style="height: 50px;color:#fff;"  border="1">
      ...
      $tampil=mysqli_query($con, "SELECT * FROM users 
        ...
        WHERE id_gel IN ('3') AND status_pmb IN ('1') ORDER BY id_user DESC");
      $no=1;
