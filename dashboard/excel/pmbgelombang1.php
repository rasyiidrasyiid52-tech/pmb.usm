...
header("Content-Disposition: attachment; filename=PMB Gelombang 1 $tgl.xls");
...
<body>
  ...
  <table>
    ...
    <tr style="text-transform: uppercase;"><th colspan="53" align="left" style="text-transform: uppercase;"><h1 style="text-transform: uppercase;">Data PMB Jalur PMDK <?php echo $app['nama']?></h1></th></tr>
    <tr style="height: 50px;color:#fff;"  border="1">
      ...
      $tampil=mysqli_query($con, "SELECT * FROM users 
        ...
        WHERE id_gel IN ('1') AND status_pmb IN ('1') ORDER BY id_user DESC");
      $no=1;
