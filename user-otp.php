    ...
    <div class="login-logo">
      ...
      <div class="card shadow">
        <div class="card-body login-card-body" style="border-radius: 10px;">
         ...
         <form action="userotp" method="post" autocomplete="" class="form-horizontal" role="form">
          ...
          <div class="row">
            <div class="col-sm-6 col-md-6">
              <center>
               <button style="border-radius: 20px;border: 2px solid #EFE4E4;width: 100%;" class="btn btn-sm bg-primary" name="check"><i class="fa fa-send faa-tada animated-hover"></i> Kirim</button> 
             </center>
           </div> 
           <div class="col-sm-6 col-md-6">
            <center>
      ...
      <footer>
        <center>
          ...
          <p style="font-size: 10px;"> <b>
            Copyright <i class="fa fa-copyright"></i> 2020 - <?php echo date("Y");?><br> Aplikasi <?php echo "$iden[aplikasi]";?><br>powered by <a type="button" class="badge bg-danger" target="blank"  data-toggle="tooltip" data-placement="bottom" title="Klik Developer" onclick="window.location.href='https://www.youtube.com/channel/UCh3zMcSY8-XpetX_Zq29e_w?view_as=subscriber?sub_confirmation=1>'">LOKON!D</a></b>
          </p>
        </center>    
      </footer>
    </div>
